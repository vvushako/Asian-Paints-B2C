...
/**
 * This is the extension manager of the Paypal extension.
 */
public class PaypalManager extends GeneratedPaypalManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PaypalManager.class.getName());
	...
	{
		return (PaypalManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PaypalConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaypalManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PaypalManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PaypalManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PaypalManager called, current tenant: " + getTenant().getTenantID());
		}
	}
