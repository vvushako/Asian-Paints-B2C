...
<%@ taglib prefix="checkout" tagdir="/WEB-INF/tags/addons/b2ccheckoutaddon/mobile/checkout/multi"%>
<%@ taglib prefix="checkout-paypal" tagdir="/WEB-INF/tags/addons/paypaladdon/mobile/checkout/multi"%>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
<%@ taglib prefix="cms" uri="http://hybris.com/tld/cmstags"%>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
<%@ taglib prefix="common" tagdir="/WEB-INF/tags/mobile/common"%>
<%@ taglib prefix="multi-checkout" tagdir="/WEB-INF/tags/addons/b2ccheckoutaddon/mobile/checkout/multi"%>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<jsp:body>
		...
		<div data-theme="d" data-role="content">
			<div data-theme="b">
				<checkout-paypal:summaryFlow deliveryMode="${deliveryMode}" paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}"
						cartData="${cartData}" />
			</div>
		</div>
		<div data-theme="d">
