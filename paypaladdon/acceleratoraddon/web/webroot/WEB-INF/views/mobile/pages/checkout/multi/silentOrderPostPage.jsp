		...
		<div class="span-20 last multicheckout silent-order-post-page">
			<div class="item_container_holder">
				...
				<label for="paymentMethodPayPal">
					<cms:pageSlot position="MobilePayPalSectionSlot" var="feature" >
					    <cms:component component="${feature}"/>
					</cms:pageSlot>
				</label>
				<input id="paymentMethodCC" type="radio" name="paymentMethodSelection" value="cc"/>
				<label for="paymentMethodCC" class="headline paymentMethodCCButton"><spring:theme code="mobile.checkout.multi.paymentMethod.addPaymentDetails.method.card"/></label>
				...
				<div class="item_container">
					...
					<button id="payPalSilentOrderSubmitButton" data-theme="c" class="form" tabindex="19">
						<spring:theme code="mobile.checkout.multi.button.submit" text="Submit" />
					</button>
