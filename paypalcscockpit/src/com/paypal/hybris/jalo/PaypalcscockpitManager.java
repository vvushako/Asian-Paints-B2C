...
/**
 * This is the extension manager of the Paypalcscockpit extension.
 */
public class PaypalcscockpitManager extends GeneratedPaypalcscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PaypalcscockpitManager.class.getName());
	 ...
	 */
	public static PaypalcscockpitManager getInstance()
	{
		return (PaypalcscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PaypalcscockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PaypalcscockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PaypalcscockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PaypalcscockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PaypalcscockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
