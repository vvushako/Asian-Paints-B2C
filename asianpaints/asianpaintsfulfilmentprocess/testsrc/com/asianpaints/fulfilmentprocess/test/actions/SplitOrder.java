 ...
 *
 */
package com.asianpaints.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AsianpaintsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AsianpaintsFulfilmentProcessConstants.PARENT_PROCESS);
