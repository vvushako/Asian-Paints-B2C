 ...
 *
 */
package com.asianpaints.test.setup;
...
import com.asianpaints.test.constants.AsianpaintsTestConstants;
import com.asianpaints.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AsianpaintsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/asianpaintstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/asianpaintstest/import/reviews.impex");
			...
			importImpexFile(context, "/asianpaintstest/import/cstickets.impex");
		}
	}
}
