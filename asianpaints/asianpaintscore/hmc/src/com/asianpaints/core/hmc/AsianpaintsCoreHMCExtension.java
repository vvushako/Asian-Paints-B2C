 ...
 *
 */
package com.asianpaints.core.hmc;
...
/**
 * Provides necessary meta information about the asianpaintscore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AsianpaintsCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AsianpaintsCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.asianpaints.core.hmc.locales";
