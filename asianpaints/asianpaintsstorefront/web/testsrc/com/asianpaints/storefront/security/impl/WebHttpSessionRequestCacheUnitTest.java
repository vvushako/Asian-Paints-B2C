...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/asianpaintsstorefront/electronics/en",
						"https://electronics.local:9002/asianpaintsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/asianpaintsstorefront/electronics/en",
						"https://electronics.local:9002/asianpaintsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/asianpaintsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/asianpaintsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/asianpaintsstorefront/electronics/en",
						"https://electronics.local:9002/asianpaintsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/asianpaintsstorefront",
						"https://electronics.local:9002/asianpaintsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/asianpaintsstorefront",
						"https://electronics.local:9002/asianpaintsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/asianpaintsstorefront/electronics/en",
						"https://electronics.local:9002/asianpaintsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
