...
<table class="account-profile-data">
	...
	<!-- Contact Number added to store in customerData -->
	<tr>
...
<a class="button" href="update-contactNumber"><spring:theme code="text.account.profile.updateContactNumber" text="Contact Number"/></a>
