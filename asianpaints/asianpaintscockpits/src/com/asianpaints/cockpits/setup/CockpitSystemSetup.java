 ...
 *
 */
package com.asianpaints.cockpits.setup;
...
import com.asianpaints.cockpits.constants.AsianpaintsCockpitsConstants;
 ...
 */
@SystemSetup(extension = AsianpaintsCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AsianpaintsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AsianpaintsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AsianpaintsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/asianpaintscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
